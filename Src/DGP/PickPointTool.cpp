...
namespace MagicDGP
{
    ...
    int PickPointTool::PickMeshVertexByPoint(const Mesh3D* pMesh, MagicMath::Vector2 mousePos, bool ignoreBack)
    {
    ...
    int PickPointTool::PickMeshVertexByPoint(const LightMesh3D* pMesh, MagicMath::Vector2 mousePos, bool ignoreBack)
    {
        if (MagicCore::RenderSystem::GetSingleton()->GetSceneManager()->hasSceneNode("ModelNode") == false)
        {
            return -1;
    ...
    void PickPointTool::PickMeshVertexByRectangle(const Mesh3D* pMesh, MagicMath::Vector2 pos0, 
    ...
    void PickPointTool::PickMeshVertexByRectangle(const LightMesh3D* pMesh, MagicMath::Vector2 pos0, 
            MagicMath::Vector2 pos1, std::vector<int>& pickIndex, bool ignoreBack)
    {
        pickIndex.clear();
        double minX = (pos0[0] < pos1[0]) ? pos0[0] : pos1[0];
    ...
    void PickPointTool::PickMeshVertexByCycle(const Mesh3D* pMesh, MagicMath::Vector2 centerPos, 
    ...
    void PickPointTool::PickMeshVertexByCycle(const LightMesh3D* pMesh, MagicMath::Vector2 centerPos, 
            double radius, std::vector<int>& pickIndex, bool ignoreBack)
    {
        Ogre::Matrix4 worldM = MagicCore::RenderSystem::GetSingleton()->GetSceneManager()->getSceneNode("ModelNode")->_getFullTransform();
        Ogre::Matrix4 viewM  = MagicCore::RenderSystem::GetSingleton()->GetMainCamera()->getViewMatrix();
    ...
    int PickPointTool::PickPointSetByPoint(const Point3DSet* pPS, MagicMath::Vector2 mousePos, bool ignoreBack)
    {
        if (MagicCore::RenderSystem::GetSingleton()->GetSceneManager()->hasSceneNode("ModelNode") == false)
        {
            return -1;
    ...
    void PickPointTool::PickPointSetByRectangle(const Point3DSet* pPS, MagicMath::Vector2 pos0,
            MagicMath::Vector2 pos1, std::vector<int>& pickIndex, bool ignoreBack)
    {
        pickIndex.clear();
        double minX = (pos0[0] < pos1[0]) ? pos0[0] : pos1[0];
    ...
    void PickPointTool::PickPointSetByCycle(const Point3DSet* pPS, MagicMath::Vector2 centerPos, 
            double radius, std::vector<int>& pickIndex, bool ignoreBack)
    {
        Ogre::Matrix4 worldM = MagicCore::RenderSystem::GetSingleton()->GetSceneManager()->getSceneNode("ModelNode")->_getFullTransform();
        Ogre::Matrix4 viewM  = MagicCore::RenderSystem::GetSingleton()->GetMainCamera()->getViewMatrix();
    ...
    void PickPointTool::SetPickParameter(PickMode pm, bool ignoreBack, LightMesh3D* pLightMesh, Mesh3D* pMesh, Point3DSet* pPS)
    {
        mPickMode = pm;
    ...
    void PickPointTool::MousePressed(int mousePosX, int mousePosY)
    {
        mMousePos = MagicMath::Vector2(mousePosX * 2.0 / MagicCore::RenderSystem::GetSingleton()->GetRenderWindow()->getWidth() - 1.0, 
                    1.0 - mousePosY * 2.0 / MagicCore::RenderSystem::GetSingleton()->GetRenderWindow()->getHeight());
        mPickPressed = true;
    }

    void PickPointTool::MouseMoved(int mousePosX, int mousePosY)
    {
        MagicMath::Vector2 curPos(mousePosX * 2.0 / MagicCore::RenderSystem::GetSingleton()->GetRenderWindow()->getWidth() - 1.0, 
                1.0 - mousePosY * 2.0 / MagicCore::RenderSystem::GetSingleton()->GetRenderWindow()->getHeight());
        UpdateMarkObject(mMousePos, curPos);
    }

    void PickPointTool::MouseReleased(int mousePosX, int mousePosY)
    {
